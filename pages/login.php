		...
		<div class="login-content">
			...
			<form action="login.php" method="POST">
				<div class="form-floating mb-20px">
					<input type="text" id="email" class="form-control fs-13px h-45px border-0" placeholder="Email Address" />
					<label for="emailAddress" class="d-flex align-items-center text-gray-600 fs-13px">Email Address</label>
				</div>
				<div class="form-floating mb-20px">
					<input type="password" id="password" class="form-control fs-13px h-45px border-0" placeholder="Password" />
...
<script>
	App.setPageTitle('<?php echo $globals['platform_name']; ?> | Login v2');
	App.setPageOption({
		appWithoutSidebar: true,
		appWithoutHeader: true,
		appClass: 'p-0',
		appContentClass: 'p-0',
		bodyClass: 'pace-top',

...
<head>
	...
	<link href="assets/css/material/theme/blue.min.css" rel="stylesheet">
		...
		<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-content-full-height">
			...
			<?php function job() { ?>
				...
				<?php 
					...
					// calc profit per job
					$billable_items = ( $job['approved_labour'] + $job['approved_paint'] + $job['approved_additional'] );
					$job['profit'] = ( $billable_items / 100 * $customer['service_charge_percentage'] );

					// job photos
					$job['photos'] = get_job_photos( $job_id );
				?>
														...
														<?php foreach( $job['photos'] as $photo ) { ?>
															...
															<div class="image gallery-group-1">
																...
																<div class="image-info">
																	...
																	<div class="desc">
																		<a href="#" onclick="job_photo_delete( <?php echo $photo['id']; ?> );"><button class="btn btn-sm btn-danger">Delete</button></a>
																	</div>
																</div>
															</div>
														<?php } ?>
			...
			<?php function providers() { ?>
				...
				<!-- add provider modal -->
				<form class="form" method="post" action="actions.php?a=provider_add">
					<div class="modal fade" id="provider_add" tabindex="-1" role="dialog" aria-labelledby="provider_add" aria-hidden="true">
					   	<div class="modal-dialog modal-notice">
						  	<div class="modal-content">
							 	<div class="modal-header">
									<h5 class="modal-title" id="myModalLabel">Add Provider</h5>
									<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
										x
									</button>
							 	</div>
							 	<div class="modal-body">
							 		<div class="row">
										<div class="col-xl-12 col-sm-12">
											<div class="form-group">
												<label class="bmd-label-floating"><strong>Company Name</strong></label>
												<input type="text" id="add_customer_company_name" name="name" class="form-control" required>
											</div>
										</div>
				 	...
				 	<div class="modal-body">
				 		<div class="row">
							...
							<div class="col-xl-6 col-sm-12">
								<div class="form-group">
									<label class="bmd-label-floating"><strong>VRN</strong></label>
									<input type="text" id="add_job_crn" name="vrn" class="form-control" required>
								</div>
							</div>
							<div class="col-xl-6 col-sm-12">
								<div class="form-group">
